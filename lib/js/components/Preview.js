...
var Preview = /** @class */ (function (_super) {
    ...
    Preview.prototype.render = function () {
        ...
        return (React.createElement("div", { className: (0, ClassNames_1.classNames)("mde-preview", classes, { loading: loading }), style: { minHeight: minHeightVal }, "data-testid": "mde-preview" }, content));
    };
    return Preview;
}(React.Component));
