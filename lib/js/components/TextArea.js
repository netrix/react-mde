...
var TextArea = /** @class */ (function (_super) {
    ...
    function TextArea(props) {
        ...
        _this.loadEmptySuggestion = function (target, key) {
            var caret = (0, TextAreaCaretPosition_1.getCaretCoordinates)(target, key);
        ...
        _this.handleSuggestionSelected = function (index) {
            ...
            (0, InsertTextAtPosition_1.insertText)(_this.getTextArea(), mention.suggestions[index].value + " ");
            _this.setState({
                mention: {
                    status: "inactive",
                    suggestions: []
            ...
            switch (mention.status) {
                ...
                case "active":
                    if (key === "Escape" ||
                        ...
                        _this.setState({
                            mention: __assign(__assign({}, mention), { focusIndex: (0, Math_1.mod)(mention.focusIndex + focusDelta, mention.suggestions.length) })
                        });
                    }
                    else if (key === "Enter" &&
    ...
    TextArea.prototype.render = function () {
        var _this = this;
        var _a = this.props, classes = _a.classes, readOnly = _a.readOnly, textAreaProps = _a.textAreaProps, height = _a.height, heightUnits = _a.heightUnits, value = _a.value, suggestionTriggerCharacters = _a.suggestionTriggerCharacters, loadSuggestions = _a.loadSuggestions, suggestionsDropdownClasses = _a.suggestionsDropdownClasses, textAreaComponent = _a.textAreaComponent, onPaste = _a.onPaste, onDrop = _a.onDrop, invisible = _a.invisible;
        ...
        return (React.createElement("div", { className: (0, ClassNames_1.classNames)({ invisible: invisible }, "mde-textarea-wrapper") },
            React.createElement(TextAreaComponent, __assign({ className: (0, ClassNames_1.classNames)("mde-text", classes), style: { height: heightVal }, ref: this.props.refObject, readOnly: readOnly, value: value, "data-testid": "text-area" }, textAreaProps, { onChange: function (event) {
                    var _a;
