...
var ReactMde = /** @class */ (function (_super) {
    ...
    ReactMde.prototype.render = function () {
        ...
        return (React.createElement("div", { className: (0, ClassNames_1.classNames)("react-mde", "react-mde-tabbed-layout", classes === null || classes === void 0 ? void 0 : classes.reactMde) },
            ...
            React.createElement(_1.TextArea, { classes: classes === null || classes === void 0 ? void 0 : classes.textArea, suggestionsDropdownClasses: classes === null || classes === void 0 ? void 0 : classes.suggestionsDropdown, suggestionsAutoplace: this.props.suggestionsAutoplace, refObject: this.finalRefs.textarea, onChange: this.handleTextChange, onPaste: this.handlePaste, onDrop: this.handleDrop, readOnly: readOnly, textAreaComponent: textAreaComponent, textAreaProps: childProps && childProps.textArea, height: this.state.editorHeight, heightUnits: this.props.heightUnits, value: value, suggestionTriggerCharacters: suggestionTriggerCharacters, loadSuggestions: loadSuggestions, onPossibleKeyCommand: this.commandOrchestrator.handlePossibleKeyCommand, invisible: selectedTab !== "write" }),
            this.props.paste && (React.createElement("label", { className: (0, ClassNames_1.classNames)("image-tip") },
                React.createElement("input", { className: (0, ClassNames_1.classNames)("image-input"), type: "file", accept: (_a = this.props.paste.accept) !== null && _a !== void 0 ? _a : pasteOptionDefaults.accept, multiple: (_b = this.props.paste.multiple) !== null && _b !== void 0 ? _b : pasteOptionDefaults.multiple, onChange: this.handleImageSelection }),
    ...
    ReactMde.defaultProps = {
        commands: (0, defaults_1.getDefaultCommandMap)(),
        toolbarCommands: (0, defaults_1.getDefaultToolbarCommands)(),
