...
var SuggestionsDropdown = function (_a) {
    ...
    if (suggestionsAutoplace &&
        ...
        style.left = left;
    return (React.createElement("ul", { className: (0, ClassNames_1.classNames)("mde-suggestions", classes), style: style }, suggestions.map(function (s, i) { return (React.createElement("li", { onClick: handleSuggestionClick, onMouseDown: handleMouseDown, key: i, "aria-selected": focusIndex === i ? "true" : "false", "data-index": "".concat(i) }, s.preview)); })));
};
