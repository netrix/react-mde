...
var TextAreaTextApi = /** @class */ (function () {
    ...
    TextAreaTextApi.prototype.replaceSelection = function (text) {
        ...
        (0, InsertTextAtPosition_1.insertText)(textArea, text);
...
var CommandOrchestrator = /** @class */ (function () {
    function CommandOrchestrator(customCommands, textArea, l18n, pasteOptions) {
        ...
        this.getCommand = function (name) {
            ...
            if (!command) {
                throw new Error("Cannot execute command. Command not found: ".concat(name));
            }
            return command;
        };
        /**
        ...
        this.commandMap = __assign(__assign({}, (0, __1.getDefaultCommandMap)()), (customCommands || {}));
        this.pasteOptions = pasteOptions;
        this.keyActivatedCommands = (0, command_utils_1.extractKeyActivatedCommands)(customCommands);
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.pasteOptions) {
                    return [2 /*return*/, this.executeCommand(this.pasteOptions.command || (0, defaults_1.getDefaultSaveImageCommandName)(), {
