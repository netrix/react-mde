            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        breaksBeforeCount = (0, MarkdownUtil_1.getBreaksNeededForEmptyLineBefore)(initialState_1.text, initialState_1.selection.start);
                        breaksBefore = Array(breaksBeforeCount + 1).join("\n");
                        placeHolder = "".concat(breaksBefore, "![").concat(l18n.uploadingImage, "]()");
                        textApi.replaceSelection(placeHolder);
                        blob = items[index];
                        return [4 /*yield*/, (0, files_1.readFileAsync)(blob)];
                    case 2:
                    ...
                    case 3:
                        ...
                        if (uploadingText === placeHolder) {
                            ...
                            realImageMarkdown = imageUrl
                                ? "".concat(breaksBefore, "![image](").concat(imageUrl, ")")
                                : "";
